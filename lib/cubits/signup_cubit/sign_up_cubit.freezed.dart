...
class _$_SignUpState extends _SignUpState {
  ...
  @override
  String toString() {
    return 'SignUpState(email: $email, password: $password, firstName: $firstName, isLoading: $isLoading, isSuccess: $isSuccess, dialogException: $dialogException, emailException: $emailException, passwordException: $passwordException)';
  }
...
abstract class _SignUpState extends SignUpState {
  const factory _SignUpState(
      ...
      required AppExceptions dialogException,
      required AppExceptions emailException,
      required AppExceptions passwordException}) = _$_SignUpState;
